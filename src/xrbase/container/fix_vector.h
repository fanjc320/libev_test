...
{
    /*
     * fix_vector is a vector with fixed size, can be used
    ...
    struct fix_vector
    {
        ...
        fix_vector(const fix_vector& vector) : used_count(0)
        {
        ...
        fix_vector& operator=(const fix_vector& vector)
        {
            if (this == &vector)
                return *this;
        ...
        {
            CHECK_LOG_RETVAL(index < used_count, end());
        ...
        {
            CHECK_LOG_RETNONE(index < used_count);
