...
static unsigned long crc32_combine_(unsigned long crc1, unsigned long crc2, int64_t len2);
...
/* ========================================================================= */
unsigned long ZEXPORT crc32_z(unsigned long crc, const unsigned char* buf, unsigned long len)
{
...
/* ========================================================================= */
unsigned long ZEXPORT crc32(unsigned long crc, const unsigned char* buf, unsigned long len)
{
...
/* ========================================================================= */
unsigned long ZEXPORT crc32_combine(unsigned long crc1, unsigned long crc2, unsigned long len2)
{
    return crc32_combine_(crc1, crc2, len2);
}

unsigned long ZEXPORT crc32_combine64(unsigned long crc1, unsigned long crc2, int64_t len2)
{
    return crc32_combine_(crc1, crc2, len2);
}
